...
define([
  ...
  'model/useraccount',
  'view/15.0.0/settings/user/userlist/userlist',
  'view/15.0.0/settings/user/usermaintenance/adduser',
  'view/15.0.0/settings/user/usermaintenance/maintainuser',
  'text!template/15.0.0/settings/user/user.tpl.html'
