...
define([
  ...
  'view/15.0.0/settings/manager/administrators',
  'view/15.0.0/settings/manager/userroles',
  'text!template/15.0.0/settings/manager/managerpage.tpl.html'
], function($, $$, _, Backbone, Global, Method, Service,
  PreferenceCollection, UserRoleCollection, AdministratorsView, UserRoleView, template) {
