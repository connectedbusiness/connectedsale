...
define([
  ...
  'view/15.0.0/settings/category/lookupcategories',
  'view/15.0.0/settings/category/currentcategories',
  'text!template/15.0.0/settings/category/categorypage.tpl.html',
  'view/spinner',
  ...
  var CartView = Backbone.View.extend({
    ...
    SetLookUpCategories: function(collection) {
      var tempCollection = new CategoryCollection();
      tempCollection.reset(collection);
      tempCollection.each(function(model) {
        var _desc = model.get("Description");
        model.set({
          FormattedCategoryDescription: _desc
        });
      });
