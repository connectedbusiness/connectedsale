define([
  ...
  'shared/enum',
  'shared/shared',
  'text!template/15.0.0/pos/item/header-info/salesrep/salesrepdetail.tpl.html'
  ...
  return Backbone.View.extend({
    ...
    isSameSalesRepCodeWithCustomer: function () {
      if (Global.CurrentCustomer.CurrentSalesRep == null) {
        var CurrentSalesRep = '';
         ...
         if (Global.SalesRepList != null && !Shared.IsNullOrWhiteSpace(Global.SalesRepList)) {
		  ...
		  if (IsSameSalesRep != null) {
			this.model.set('CommissionPercent', IsSameSalesRep.CommissionPercent);
			return true;
		  }
		  else {
			this.model.set('CommissionPercent', 0); 
		  }
		}
        else {
          ...
          if(CurrentSalesRep == this.model.get("SalesRepGroupCode")) {
            this.model.set('CommissionPercent', 100); 
            return true
          }
          else {
            this.model.set('CommissionPercent', 0);
        ...
        if (IsSameSalesRep != null) {
          this.model.set('CommissionPercent', IsSameSalesRep.get("CommissionPercent"));
          return true;
        }
        else{
          this.model.set('CommissionPercent', 0); 
    ...
    ChangeCommissionInput: function(e) {
      ...
      this.model.set("CommissionPercent", value);
    },
