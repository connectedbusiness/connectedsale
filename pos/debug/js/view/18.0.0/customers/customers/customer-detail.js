...
define([
  ...
  'model/contact',
  'collection/base',
  'view/16.0.0/customers/customers/detail/general',
  'view/16.0.0/customers/customers/detail/contacts',
  'view/16.0.0/customers/customers/detail/note',
  'text!template/16.0.0/customers/customers/customer-detail.tpl.html'
    ...
    btnSave_click: function(e) {
      ...
      switch (this.CurrentTab) {
        ...
        case Tabs.Note:
          ...
          break;
          //case Tabs.Contact : this.trigger('newContactSaved', this);  break;
      }
    },
