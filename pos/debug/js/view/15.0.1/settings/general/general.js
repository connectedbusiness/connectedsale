...
define([
  ...
  'view/15.0.1/settings/general/imagesize/imagesize',
  'view/15.0.1/settings/general/website/websitelist',
  'view/15.0.1/settings/general/customer/customers',
  'view/15.0.1/settings/general/taxscheme/taxschemes',
  'view/15.0.1/settings/general/location/locations',
  'view/15.0.1/settings/general/gateway/gateways',
  'view/15.0.1/settings/general/paymenttype/paymenttypes',
  'view/15.0.1/settings/general/workstation/workstations',
  'view/15.0.1/settings/general/kiosk/kiosk',
  'view/15.0.1/settings/general/pos/pos',
  'view/15.0.1/settings/general/email/email',
  'text!template/15.0.1/settings/general/generalpage.tpl.html',
  'text!template/15.0.1/settings/general/email/defaultmessage.tpl.html',
  ...
  BaseCollection, WebsiteCollection, CustomerCollection, CategoryCollection, LocationCollection, GatewayCollection, PaymentTypeCollection, PreferenceCollection, WorkstationCollection, UserRoleCollection, LocalPreferenceCollection,
  ImageSizePreference, WebsiteListPreference, CustomersPreference, TaxSchemePreference, LocationsPreference,GatewaysPreference, PaymentTypesPreference,WorkstationsPreference, KioskPreference, POSPreference, EmailPreference,
  ...
  var GeneralSettingsView = Backbone.View.extend({
    ...
    trackDrawerBalance_change: function(checked, checkSwitch) {
      ...
      if (!Global.Preference.TrackDrawerBalance && Global.Status.IsOpen && !checked) {
        ...
        this.trackDrawerSwitch = checkSwitch;
    ...
    InitializeGeneralDisplay: function() {
      ...
      if (Global.isBrowserMode) Shared.UseBrowserScroll('#settings-right-pane #right-pane-content');
    ...
    AllowTransactionChange: function(checkSwitch) {
      ...
      for (var i = 0; i < _defaultTransactions.length; i++) { // CSL - 6527	: 4.23.13
        switch (_booleanSettings[_defaultTransactions[i]]) {
          case "AllowSales":
            _checked = allowSales.getState();
            break;
          case "AllowOrders":
            _checked = allowOrders.getState();
            break;
          case "AllowQuotes":
            _checked = allowQuotes.getState();
            break;
          case "AllowReturns":
            _checked = allowReturns.getState();
            break;
            if (_checked) break;
        };
    ...
    ToggleCheckboxes: function() {
      ...
      var _booleanSettings = ["AllowSales", "AllowQuotes", "AllowOrders", "AllowReturns",
        ...
        "AllowChangePaymentTerm", "AllowChangeTaxCode", "IsUseCustomerShipToPaymentType","IsAllowViewZXTape"
      ];
      var _self = this;
        ...
        function(setting) {
          ...
          switch (setting) {
            ...
            case "AllowChangePrice":
              this.allowChangePrice = chk;
              break;
            case "AllowChangePaymentTerm":
              this.allowChangePaymentTerm = chk;
              break;
            case "AllowChangeTaxCode":
              this.allowChangeTaxCode = chk;
              break;
            case "AllowAddCustomer":
              this.allowAddCustomer = chk;
              break;
            case "TaxByLocation":
              this.taxByLocation = chk;
              break;
            case "ShowCouponList":
              this.showCouponList = chk;
              break;
            case "IsUseItemDescription":
              this.isUseItemDescription = chk;
              break;
            case "IsDepositPayment":
              this.isDepositPayment = chk;
              break;
            case "IsOverrideSalesRep":
              this.isOverrideSalesRep = chk;
              break;
            case "ShowWholesalePrice":
              this.showWholesalePrice = chk;
              break;
            ...
            case "IsUseISEImage": //added by PR.Ebron(03.22.13) >> INTMOBA-810 >> ISE web images
              this.isUseISEImage = chk;
              break;
            case "AllowChangeClassTemplate":
              this.allowChangeClassTemplate = chk;
              break;
            case "AllowTaxOnLineItems":
              this.allowTaxOnLineItems = chk;
              break;

              //VER. 14
            case "AskForCustomerPO":
              this.askForCustomerPO = chk;
              break;
            case "AskForShipDate":
              this.askForShipDate = chk;
              break;
            case "AskForSource":
              this.askForSource = chk;
              break;
            case "IsTrackStorePickUp":
              this.trackStorePickUp = chk;
              break;
            case "IsUseCustomerShipToPaymentType":
              this.isUseCustomerShipToPaymentType = chk;
              break;
            case "IsAllowViewZXTape":
              this.isAllowViewZXTape = chk;
              break;
          }
            ...
            case "AllowReturns":
              chk.bind({
                'checkSwitch:on': function(ev) {
                  _self.CheckTransactionState(ev.checkSwitch);
                  _self.AllowTransactionChange(ev.checkSwitch);
            ...
            case "TrackDrawerBalance":
              chk.bind({
                'checkSwitch:on': function(ev) {
                  ...
                  _self.trackDrawerBalance_change(true, ev.checkSwitch);
                },
                'checkSwitch:off': function(ev) {
                  Global.trackDrawerBalanceState = false;
                  _self.DisableBlindClose();
                  _self.trackDrawerBalance_change(false, ev.checkSwitch)
                }
              });
              break;
            case "BlindClose":
            ...
            case "IsUseISEImage":
              chk.bind({
                'checkSwitch:on': function(e) {
                  Global.IsUseImage = true;
                  _self.EnableISEImageSettings(true);
                },
                'checkSwitch:off': function(e) {
                  Global.IsUseImage = false;
                  _self.EnableISEImageSettings(false);
                }
              });
              break;
            case "IsUseCustomerShipToPaymentType":
                chk.bind({
                  'checkSwitch:on': function(e) {
                    _self.isUseCustomerShipToPaymentType_change(false);
                  },
                  'checkSwitch:off': function(e) {
                    _self.isUseCustomerShipToPaymentType_change(true);
                  }
                });
                break;
            case "IsAllowViewZXTape":
                chk.bind({
                  'checkSwitch:on': function(e) {
                    _self.isAllowViewZXTape_change(true);
                  },
                  'checkSwitch:off': function(e) {
                    _self.isAllowViewZXTape_change(false);
                  }
                });
                break;
            case "UseCashDrawer":
              chk.bind({
                'checkSwitch:on': function(e) {
                  _self.useCashDrawer_change(chk);
                }
              });
              break;
              //case "IsTrackStorePickUp":
        ...
        function(setting) {
          ...
          switch (setting) {
            ...
            case "AllowReturns":
              ...
              break;
            case "AllowChangePrice":
              _checked = this.allowChangePrice.getState();
              _settings.set({
                AllowChangePrice: _checked
              });
              break;
            case "AllowChangePaymentTerm":
              _checked = this.allowChangePaymentTerm.getState();
              _settings.set({
                AllowChangePaymentTerm: _checked
              });
              break;
            case "AllowChangeTaxCode":
              _checked = this.allowChangeTaxCode.getState();
              _settings.set({
                AllowChangeTaxCode: _checked
              });
              break;
            case "AllowAddCustomer":
              _checked = this.allowAddCustomer.getState();
              _settings.set({
                AllowAddCustomer: _checked
              });
              break;
            case "TaxByLocation":
              _checked = this.taxByLocation.getState();
              _settings.set({
                TaxByLocation: _checked
              });
              break;
            case "ShowCouponList":
              _checked = this.showCouponList.getState();
              _settings.set({
                ShowCouponList: _checked
              });
              break;
            case "IsUseItemDescription":
              _checked = this.isUseItemDescription.getState();
              _settings.set({
                IsUseItemDescription: _checked
              });
              break;
            case "IsDepositPayment":
              _checked = this.isDepositPayment.getState();
              _settings.set({
                IsDepositPayment: _checked
              });
              break;
            case "IsUseCustomerShipToPaymentType":
              _checked = this.isUseCustomerShipToPaymentType.getState();
              _settings.set({
                IsUseCustomerShipToPaymentType: _checked
              });
              break;
            case "IsAllowViewZXTape":
              _checked = this.isAllowViewZXTape.getState();
              _settings.set({
                IsAllowViewZXTape: _checked
              });
              break;
            case "IsOverrideSalesRep":
              _checked = this.isOverrideSalesRep.getState();
              _settings.set({
                IsOverrideSalesRep: _checked
              });
              break;
            case "ShowWholesalePrice":
              _checked = this.showWholesalePrice.getState();
              _settings.set({
            ...
            case "UseCashDrawer":
              ...
              //Misc * END * 12/7/2012
            case "IsUseISEImage": //added by PR.Ebron(03.22.13) >> INTMOBA-810 >> ISE web images
              _checked = this.isUseISEImage.getState();
              _settings.set({
                IsUseISEImage: _checked
              });
              break;
            case "AllowChangeClassTemplate":
              _checked = this.allowChangeClassTemplate.getState();
              _settings.set({
                AllowChangeClassTemplate: _checked
              });
              break;
            case "AllowTaxOnLineItems":
              _checked = this.allowTaxOnLineItems.getState();
              _settings.set({
              ...
              //VER. 14
            case "AskForCustomerPO":
              _checked = this.askForCustomerPO.getState();
              _settings.set({
                AskForCustomerPO: _checked
              });
              break;
            case "AskForShipDate":
              _checked = this.askForShipDate.getState();
              _settings.set({
                AskForShipDate: _checked
              });
              break;
            case "AskForSource":
              _checked = this.askForSource.getState();
              _settings.set({
                AskForSource: _checked
              });
              break;
            case "IsTrackStorePickUp":
              _checked = this.trackStorePickUp.getState();
              _settings.set({
