...
define([
  ...
  'model/useraccount',
  'view/15.0.1/settings/user/userlist/userlist',
  'view/15.0.1/settings/user/usermaintenance/adduser',
  'view/15.0.1/settings/user/usermaintenance/maintainuser',
  'text!template/15.0.1/settings/user/user.tpl.html'
], function($, $$, _, Backbone, Global, Service, Method, Shared,
  UserAccountCollection,
  LookupCriteriaModel, UserAccountModel,
  UserListPreference, AddUserView, UserMaintenanceView,
  template) {
