...
define([
  ...
  'model/reportsetting',
  'view/15.0.1/pos/pos',
  'view/15.0.1/settings/general/general',
  'view/15.0.1/settings/category/categories',
  'view/15.0.1/settings/receipt/receipt',
  'view/15.0.1/settings/reason/reason',
  'view/15.0.1/settings/discount/discount',
  'view/15.0.1/settings/signature/signature',
  'view/15.0.1/settings/manager/managerpage',
  'view/15.0.1/settings/misc/misc',
  'view/15.0.1/settings/payment/payment',
  'view/15.0.1/settings/user/user',
  ...
  'text!template/15.0.1/settings/settings.tpl.html',
  'view/spinner',
  ...
  ManagerSettingsView, MiscSettingsView, PaymentGatewaySettingsView, UserSettingsView, ClosingAmountView, PrintPreviewView, DynamicPrintPreview, PrinterView,
  template, Spinner) {
  var _this = null;
  var SettingsView = Backbone.View.extend({
    ...
    ShowClearBtn: function(e) {
      ...
      if (_strLength <= 0) {
        ...
        var _left = '646px'
        if (e.target.id == "settings-workstation-input") _left = '620px';
        else if (e.target.id == "search-user") _left = '610px';
