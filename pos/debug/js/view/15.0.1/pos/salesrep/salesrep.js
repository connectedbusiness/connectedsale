define([
  ...
  'collection/base',
  'view/15.0.1/pos/salesrep/salesrepdetail',
  'text!template/15.0.1/pos/item/header-info/salesrep/salesreplist.tpl.html',
  'js/libs/iscroll.js'
  ...
  return Backbone.View.extend({
    ...
    close: function(e) {
      ...
      var TotalCommission = this.SelectedSalesRepCollection.reduce(function(memo, num) {
        return memo + parseFloat(num.get("CommissionPercent")); 
      }, 0);
      ...
      if (TotalCommission == 100) {
        ...
        var CommissionPercentResult = this.SelectedSalesRepCollection.pluck("CommissionPercent");
        ...
        _.each(CommissionPercentResult, function (salerep, i) { 
          ...
          { CommissionPercent += salerep + "%" } else 
          { CommissionPercent += (salerep + "%" + ", ") }
          i++;
        })}
        else {
          CommissionPercent = CommissionPercentResult;
        }
        ...
        Global.CommissionPercent = CommissionPercent;
