define([
  ...
  var Shared = {
     ...
     */
    PrintBrowserMode: {
      Print: function(transactionCode, pages) {
        ...
        if (printerTool) {
          printerTool.printReport(reprotUrl);
        }
      },
    ...
    Printer: {
      ...
      DrawerKick: function(IP, PM) {
        ...
        //window.plugins.cbReceiptPrint.OpenPrinter(IP,
        //    function (result) {
        //        console.log('Success - Open for DrawerKick');

        //    },
        //    function (result) {
        //        console.log('Error - Open for DrawerKick');
        //    }
        //);
