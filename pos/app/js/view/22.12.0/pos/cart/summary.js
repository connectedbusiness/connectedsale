...
define([
  ...
  'shared/shared',
  'shared/service',
  'text!template/22.12.0/pos/cart/summary.tpl.html'
  ...
  var ItemView = Backbone.View.extend({
    ...
    initialize: function() {
      ...
      $("#totalsummary").attr('style', 'display: none');
    },
    ...
    if (Global.TransactionType == Enum.TransactionType.SalesRefund) {
     $("#paymentsummary").attr('style', 'display: none');
     $("#balancesummary").attr('style', 'display: none');
     $("#totalsummary").attr('style', 'display: inline');
   }
   else {
    $("#paymentsummary").attr('style', 'display: inline');
    $("#balancesummary").attr('style', 'display: inline');
    $("#totalsummary").attr('style', 'display: none');
   }
