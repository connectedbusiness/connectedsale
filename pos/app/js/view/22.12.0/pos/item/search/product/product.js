...
define([
	...
	'shared/global',
	'shared/shared',
	'text!template/22.12.0/pos/item/search/product/product.tpl.html',
	...
	var ProductView = Backbone.View.extend({
		...
		SetDescription : function(model)
		{
    		...
    		model.set({
    				...
    				ItemName: _itemName,
    				CategoryCode: Shared.Escapedhtml(model.get("CategoryCode") || ''),
    				CategoryDescription: Shared.Escapedhtml(model.get("CategoryDescription") || '')
    			},{silent:true});
		},
