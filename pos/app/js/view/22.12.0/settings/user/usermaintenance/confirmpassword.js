define([
  ...
  'text!template/22.12.0/settings/user/usermaintenance/confirmpassword.tpl.html'
  ...
  var MaintainUserAccountView = Backbone.View.extend({
    ...
    Close: function() {
      ...
      // $("#settings-blockoverlay").hide();
       $("#settings-blockoverlay").css("z-index","999");
      $("#MUConfirmPassword").css("z-index","2000");
    },

    Show: function() {      
      // $("#settings-blockoverlay").show();      
      this.render();
      $("#settings-blockoverlay").css("z-index","2001");
      $("#MUConfirmPassword").css("z-index","2002");
    },
