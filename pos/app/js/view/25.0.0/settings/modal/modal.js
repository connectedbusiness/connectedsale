...
define([
  ...
  'backbone',
  'shared/global',
  'view/25.0.0/settings/general/workstation/workstations',
  'view/25.0.0/settings/general/customer/customers',
  'view/25.0.0/settings/general/location/locations',
  'view/25.0.0/settings/general/posshippingmethod/posshippingmethods',
  'view/25.0.0/settings/general/pos/pos',
  'view/25.0.0/settings/general/gateway/gateways',
  'view/25.0.0/settings/general/paymenttype/paymenttypes',
  'view/25.0.0/settings/general/website/websitelist',
  'view/25.0.0/settings/general/imagesize/imagesize',
  'view/25.0.0/settings/general/email/email',
  'view/25.0.0/settings/manager/administrators',
  'view/25.0.0/settings/manager/userroles',
  'view/25.0.0/settings/receipt/typelist/receipttypelist',
  'view/25.0.0/settings/receipt/print/printsetting',
  'view/25.0.0/settings/receipt/print/printerlist',
  'view/25.0.0/settings/user/usermaintenance/maintainuser',
  'view/25.0.0/settings/user/usermaintenance/adduser',
  'view/25.0.0/settings/dejavoo/protocol/protocol',
  'text!template/25.0.0/settings/modal/modal.tpl.html'
