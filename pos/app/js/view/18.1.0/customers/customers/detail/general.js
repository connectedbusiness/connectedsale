...
define([
  ...
  'text!template/18.1.0/customers/customers/detail/general.tpl.html',
...
//        msg = "Please enter a valid Postal Code.";
      ...
      } else if (this.IsCheckEmail(_email) && this.ValidateEmailFormat(_email) && !_isAllowByPassValidation) {
