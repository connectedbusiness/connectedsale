...
define([
  ...
  'view/15.1.0/pos/actions/actions',
  'view/15.1.0/pos/item/header-info/headerinfo',
  'view/15.1.0/pos/item/items',
  'view/15.1.0/pos/cart/cart',
  'view/15.1.0/pos/item/category/categories',
  'view/15.1.0/pos/payment/payment',
  'view/15.1.0/pos/tax/taxlist',
  'view/15.1.0/pos/item/search/product/products',
  'view/15.1.0/pos/item/search/productdetail',
  'view/15.1.0/pos/item/search/stock/stocks',
  'view/15.1.0/pos/transactiontype/transactiontype',
  'view/15.1.0/pos/transactions/transactions',
  'view/15.1.0/pos/payment/payments',
  'view/15.1.0/pos/coupon/coupon',
  'view/15.1.0/pos/signature/signature',
  'view/15.1.0/pos/reason/transactionreason',
  'view/15.1.0/pos/print/printoptions',
  'view/15.1.0/pos/print/printpreview',
  'view/15.1.0/pos/print/dynamicprint',
  'view/15.1.0/pos/print/printer',
  'view/15.1.0/pos/manageroverride/manageroverride',
  'view/15.1.0/pos/payment/refund',
  'view/15.1.0/pos/drawerbalance/openingamount',
  'view/15.1.0/pos/drawerbalance/closingamount',
  'view/15.1.0/pos/report/statusreport',
  'view/15.1.0/pos/payment/paymenttype',
  'view/15.1.0/pos/seriallot/seriallot',
  'view/15.1.0/pos/notes/notescontrol',
  'view/15.1.0/pos/customerpo/customerpo',
  'view/15.1.0/pos/giftcard/giftcard',
  'view/15.1.0/pos/item/upcitem/upcitems',
  'view/15.1.0/pos/item/gcitem/gcitems',
  'view/15.1.0/pos/pickup/pickuplist',
  'view/15.1.0/pos/bundle/configurator',
  'view/15.1.0/pos/kit/configurator',
  'view/15.1.0/pos/promotion/promotion',
  'text!template/15.1.0/header/header.tpl.html',
  'text!template/15.1.0/pos/item/search/search.tpl.html',
  'text!template/15.1.0/pos/item/search/lookup.tpl.html',
  'text!template/15.1.0/pos/pos.tpl.html',
  'view/spinner',
  'js/libs/iscroll.js',
    ...
    GetSelectedReportCode: function(reportcode, preference) {
      ...
      if (Global.PaymentType == "Credit Card") {
        if (Global.IsUseINVDiscountReport) {
          if (!Shared.IsNullOrWhiteSpace(preference.SalesReportDiscount) && preference.CreditCardReportCode == preference.SalesReportNoDiscount) {
            return preference.SalesReportDiscount;
          } else {
            return preference.CreditCardReportCode;
          }
        } else {
          return preference.CreditCardReportCode;
        }
