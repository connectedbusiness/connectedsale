...
define([
  ...
  'backbone',
  'shared/global',
  'view/15.1.0/settings/general/workstation/workstations',
  'view/15.1.0/settings/general/customer/customers',
  'view/15.1.0/settings/general/location/locations',
  'view/15.1.0/settings/general/pos/pos',
  'view/15.1.0/settings/general/gateway/gateways',
  'view/15.1.0/settings/general/paymenttype/paymenttypes',
  'view/15.1.0/settings/general/website/websitelist',
  'view/15.1.0/settings/general/imagesize/imagesize',
  'view/15.1.0/settings/general/email/email',
  'view/15.1.0/settings/manager/administrators',
  'view/15.1.0/settings/manager/userroles',
  'view/15.1.0/settings/receipt/typelist/receipttypelist',
  'view/15.1.0/settings/receipt/print/printsetting',
  'view/15.1.0/settings/user/usermaintenance/maintainuser',
  'view/15.1.0/settings/user/usermaintenance/adduser',
  'text!template/15.1.0/settings/modal/modal.tpl.html'
], function($, $$, _, Backbone, Global, WorkstationsPreference, CustomerPreference, LocationsPreference, POSPreference, GatewayPreference, PaymentTypePreference, WebsitePreference, 
  ImageSizePreference, EmailPreference, AdministratorsView, UserRoleView, ReceiptListView, PrintSettingsView ,UserMaintenanceView, UserAddView, template) {
