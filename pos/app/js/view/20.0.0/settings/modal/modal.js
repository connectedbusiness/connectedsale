...
define([
  ...
  'backbone',
  'shared/global',
  'view/20.0.0/settings/general/workstation/workstations',
  'view/20.0.0/settings/general/customer/customers',
  'view/20.0.0/settings/general/location/locations',
  'view/20.0.0/settings/general/posshippingmethod/posshippingmethods',
  'view/20.0.0/settings/general/pos/pos',
  'view/20.0.0/settings/general/gateway/gateways',
  'view/20.0.0/settings/general/paymenttype/paymenttypes',
  'view/20.0.0/settings/general/website/websitelist',
  'view/20.0.0/settings/general/imagesize/imagesize',
  'view/20.0.0/settings/general/email/email',
  'view/20.0.0/settings/manager/administrators',
  'view/20.0.0/settings/manager/userroles',
  'view/20.0.0/settings/receipt/typelist/receipttypelist',
  'view/20.0.0/settings/receipt/print/printsetting',
  'view/20.0.0/settings/receipt/print/printerlist',
  'view/20.0.0/settings/user/usermaintenance/maintainuser',
  'view/20.0.0/settings/user/usermaintenance/adduser',
  'view/20.0.0/settings/dejavoo/protocol/protocol',
  'text!template/20.0.0/settings/modal/modal.tpl.html'
