...
define([
  ...
  'backbone',
  'shared/global',
  'view/23.0.0/settings/general/workstation/workstations',
  'view/23.0.0/settings/general/customer/customers',
  'view/23.0.0/settings/general/location/locations',
  'view/23.0.0/settings/general/posshippingmethod/posshippingmethods',
  'view/23.0.0/settings/general/pos/pos',
  'view/23.0.0/settings/general/gateway/gateways',
  'view/23.0.0/settings/general/paymenttype/paymenttypes',
  'view/23.0.0/settings/general/website/websitelist',
  'view/23.0.0/settings/general/imagesize/imagesize',
  'view/23.0.0/settings/general/email/email',
  'view/23.0.0/settings/manager/administrators',
  'view/23.0.0/settings/manager/userroles',
  'view/23.0.0/settings/receipt/typelist/receipttypelist',
  'view/23.0.0/settings/receipt/print/printsetting',
  'view/23.0.0/settings/receipt/print/printerlist',
  'view/23.0.0/settings/user/usermaintenance/maintainuser',
  'view/23.0.0/settings/user/usermaintenance/adduser',
  'view/23.0.0/settings/dejavoo/protocol/protocol',
  'text!template/23.0.0/settings/modal/modal.tpl.html'
