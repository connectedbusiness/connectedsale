...
define([
  ...
  'collection/base',
  'text!template/16.0.0/pos/item/header-info/customer/customerform.tpl.html',
  'view/spinner',
  ...
  var CustomerFormView = Backbone.View.extend({
    ...
    ValidateFields: function() {
      ...
      if (postal === "" && !isAllowByPassValidation) {
        ...
        //console.log("email");
      } else if (this.IsCheckEmail(email) && Shared.ValidateEmailFormat(email) && !isAllowByPassValidation) {
