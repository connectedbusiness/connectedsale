...
define([
  ...
  'view/16.0.0/pos/keypad/keypad',
  'view/16.0.0/pos/payment/gift',
  'view/16.0.0/pos/payment/loyaltypoints',
  'view/16.0.0/pos/postal/addpostal',
  'text!template/16.0.0/pos/payment/payment.tpl.html',
  'text!template/16.0.0/pos/payment/cash.tpl.html',
  'text!template/16.0.0/pos/payment/check.tpl.html',
  'text!template/16.0.0/pos/payment/creditcard.tpl.html',
  'view/spinner',
  ...
  var PaymentView = Backbone.View.extend({
    ...
    AddCreditCardPayment: function(amount) {
      ...
      var _cardNumber = $("#cardNumber").val(),
        ...
        _track2 = $("#track2").text(),
        _ksn = $("#ksn").text(),
        _magnePrint = $("#magnePrint").text(),
        _magnePrintStatus = $("#magnePrintStatus").text(),
        _cv = $("#cvNumber").val(),
        _country = $("#ccCountry option:selected").val(),
        _postal = $("#ccPostal").val(),
        _cardName = $.trim($("#cardName").val()) || Global.CurrentCustomer.CustomerName,
        _address = $("#ccAddress").val(),
        _city = $("#ccCity option:selected").val(),
        _state = $("#ccState").val(),
        _phone = $("#ccPhone").val(),
        _phoneExt = $("#ccPhoneExt").val(),
        _email = $("#ccEmail").val(),
        ...
        _signature = "",
        _signatureContent = "",
        _isCreditCardIsAuthorizedVerbally = false,
        _isEncrypted = (_ksn != '' && _ksn != null);
