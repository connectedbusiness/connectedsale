...
define([
  ...
  'view/16.0.0/settings/general/imagesize/imagesize',
  'view/16.0.0/settings/general/website/websitelist',
  'view/16.0.0/settings/general/customer/customers',
  'view/16.0.0/settings/general/taxscheme/taxschemes',
  'view/16.0.0/settings/general/location/locations',
  'view/16.0.0/settings/general/gateway/gateways',
  'view/16.0.0/settings/general/paymenttype/paymenttypes',
  'view/16.0.0/settings/general/workstation/workstations',
  'view/16.0.0/settings/general/kiosk/kiosk',
  'view/16.0.0/settings/general/pos/pos',
  'view/16.0.0/settings/general/email/email',  
  'text!template/16.0.0/settings/general/generalpage.tpl.html',
  'text!template/16.0.0/settings/general/email/defaultmessage.tpl.html',
  ...
  var GeneralSettingsView = Backbone.View.extend({
    ...
    ToggleCheckboxes: function() {
      ...
      var _booleanSettings = ["AllowSales", "AllowQuotes", "AllowOrders", "AllowReturns",
        ...
        "AllowChangePaymentTerm", "AllowChangeTaxCode", "IsUseCustomerShipToPaymentType","IsAllowViewZXTape", "IsAutoAdjustmentStock"
      ];      
